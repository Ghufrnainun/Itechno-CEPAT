...
function FcmBridge() {
  ...
  if (permission === 'default' && !dismissed) {
    return (
      <div className="fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom,0px)+12px)] lg:bottom-6 left-4 right-4 lg:left-6 lg:right-auto lg:w-96 bg-surface-container-lowest border border-card-border shadow-lg rounded-xl p-4 z-30 flex flex-col gap-3 animate-in slide-in-from-bottom-5 font-sans">
        <div>
